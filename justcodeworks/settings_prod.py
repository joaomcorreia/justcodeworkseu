"""
Django settings for justcodeworks project - Production Settings.
...
# For multi-tenancy in production, use django-tenant-schemas
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='justcodeworks_prod'),
